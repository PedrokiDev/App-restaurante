...
class AppColors {
  ...
  static Color pedirButtonBackground = const Color(0xFF6750a4);
  ...
  //     elevation: 0,
  //     primary: buttonForeground,
  //     surfaceTintColor: buttonBackground);

  static ButtonStyle pedirButtonStyle = ElevatedButton.styleFrom(
      elevation: 0,
      primary: AppColors.pedirButtonBackground,
